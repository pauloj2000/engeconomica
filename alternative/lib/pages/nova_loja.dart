...
//
//    novaLoja.id = BancoDadosMock.itens.last.id + 1;
//    novaLoja.nome = _nomeLoja.text;
//    novaLoja.preco = double.parse(_precoProduto.text);
//    novaLoja.produtoDesc = _descricaoProduto.text;
//    novaLoja.producaoDesc = _descricaProducao.text;
//    novaLoja.imagens = null;
//
//    servicoItem.adicionaItem(novaLoja.id, 1, novaLoja.nome, novaLoja.preco, novaLoja.produtoDesc, novaLoja.producaoDesc, novaLoja.imagens);
//
//    servicoItem = null;
//  }
//
